...
impl MetalBackend {
    pub fn new(max_splats: usize) -> Result<Self, MetalRenderError> {
        ...
        Ok(Self {
            ...
            previous_source_splat_count: 0,
            previous_active_splat_count: 0,
            ...
            last_estimated_overlaps: 0,
            last_attempt_sort_count: 0,
            last_sort_path: "fused",
            ...
            last_lod_mode: "off",
            last_lod_mapping: "identity",
            last_lod_requested_splat_count: None,
            last_source_splat_count: 0,
            last_active_splat_count: 0,
            last_overlap_history_reset: false,
